...
class BadPersonNetSpec extends Specification {
    ...
    def "short circuits after four timeouts"() {
        ...
        def blacklist = new BadPersonNet("http://localhost", wireMock.port());
